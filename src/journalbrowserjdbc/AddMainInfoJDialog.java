...
public class AddMainInfoJDialog extends javax.swing.JFrame  {
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        try {
            ...
            Logger.getLogger(AddMainInfoJDialog.class.getName()).log(Level.SEVERE, null, ex);
        }
